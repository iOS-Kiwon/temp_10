...
- (void)prepare
{
    ...
    CAEmitterCell *snowCell1 = [self makeEmitterCellWithParticle:@"MochaResources.bundle/snow.png"];
...
- (CAEmitterCell *)makeEmitterCellWithParticle:(NSString *)name
{
    ...
    emitterCell.color = [[UIColor clearColor] CGColor];
...
- (void)start
{
    [[self snowLayer] setValue:@26 forKeyPath:@"emitterCells.snow.birthRate"];
