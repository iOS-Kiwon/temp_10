...
@interface AmailFMResultSet (Private)
- (NSMutableDictionary *)columnNameToIndexMap;
- (void)setColumnNameToIndexMap:(NSMutableDictionary *)value;
@end

@implementation AmailFMResultSet
@synthesize query=_query;
@synthesize columnNameToIndexMap=_columnNameToIndexMap;
@synthesize statement=_statement;

+ (id)resultSetWithStatement:(AmailFMStatement *)statement usingParentDatabase:(AmailFMDatabase*)aDB {
    
    AmailFMResultSet *rs = [[AmailFMResultSet alloc] init];
    
    [rs setStatement:statement];
    [rs setParentDB:aDB];
    
    return AmailFMDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    AmailFMDBRelease(_columnNameToIndexMap);
...
- (NSDictionary*)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return AmailFMDBReturnAutoreleased([dict copy]);
    }
    else {
...
- (void)setParentDB:(AmailFMDatabase *)newDb {
    _parentDB = newDb;
}
