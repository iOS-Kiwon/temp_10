...
@implementation SectionBAN_SLD_GBAtypeCell
@synthesize target,cell;

- (void)awakeFromNib {
    [super awakeFromNib];
    self.backgroundColor = [UIColor clearColor];
    self.cell = [[SectionBAN_SLD_GBABtypeView alloc] initWithTarget:self Nframe:CGRectMake(0, 0, APPFULLWIDTH, [Common_Util DPRateOriginVAL:160] + 10) Type:@"BAN_SLD_GBA"];
