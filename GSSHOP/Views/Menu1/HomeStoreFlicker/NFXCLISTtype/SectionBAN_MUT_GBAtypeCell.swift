//
//  SectionBAN_MUT_GBAtypeCell.swift
//  GSSHOP
//
...
class SectionBAN_MUT_GBAtypeCell: UITableViewCell {
    ...
    func setCellInfoNDrawData_Module(_ module: Module) {
        if let prd = Module( JSON: module.toJSON() ) {
            self.setCellInfoNDrawData(prd)
        }
    }
